    ...
    var e = layui.setter
        ...
        , l = function (a, d) {
            ...
            if (b.each(function (e) {
                ...
                var IframeUE = 'iframeUE' + Math.random() * 10000;
                l || (r(s).append(['<div class="layadmin-tabsbody-item layui-show">', '<iframe id="' + IframeUE + '" name="' + IframeUE +'"  src="' + a + '" frameborder="0" class="layadmin-iframe"></iframe>', "</div>"].join("")),
                    t.index = b.length,
                    i.tabAdd(o, {
                        title: "<span>" + d + "</span>",
                        id: a,
